			...
			for (var e in data) {
				...
				if (event.type === "VEVENT") {
					...
					if (typeof event.rrule != "undefined" && !isFacebookBirthday) {
						...
						//console.log("***Prueba*** Evento SIN regla: " + title + " / " + moment(today));

						//SI NO es un evento de dia completo y esta fuera del dia de hoy, se descarta
						if (!fullDayEvent && (startDate < moment(today) || startDate > moment(future))) {
							//console.log('--No es evento de dia completo: '+ startDate);
							//console.log("It's not a fullday event, and it is in the past. So skip: " + title);
							continue;
						}

						//SI es evento de dia completo y esta antes de hoy, se descarta
						if (fullDayEvent && endDate <= today) {
							//console.log("It's a fullday event, and it is before today. So skip: " + title);
							continue;
						}

						//SI es un evento de dia completo y esta despues de mañana, se descarta
						if (startDate > future) {
